...
- BI BRANCH projects: eCV, DayOne, and other BI Branch internal work
- PLATFORM45 people: Maro, Justin, Shaun Richards, Wayne
- PLATFORM45 projects: Yebo (Yebo-Tech MVP, Yebo-Thembalethu, Yebo-Carma, CARMA), ReadyGolf, Hagglz
...
If a chat contains Maro, Justin, Shaun, or Wayne, or mentions Yebo/ReadyGolf/Hagglz/CARMA - it's likely Platform45.
CARMA is part of the Yebo project - group CARMA items under Yebo.
...
- Categorise items under these headings:
  BI BRANCH (group by project: eCV, DayOne, Other)
  PLATFORM45 (group by project: Yebo/CARMA, ReadyGolf, Hagglz, Other)
  PERSONAL (direct messages from friends/family including Llewelyn)
